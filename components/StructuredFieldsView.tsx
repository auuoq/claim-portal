...
const FIELD_LABELS: Record<string, string> = {
  ...
  noi_dang_ky_bhyt_ban_dau: "Nơi đăng ký BHYT ban đầu",
  thoi_gian_dieu_tri: "Thời gian điều trị",
  ma_icd: "Mã ICD",
  loai: "Loại",
  noi_dung: "Nội dung",
  ...
  has_stamp_or_digital_signature: "Có dấu đỏ / chữ ký số",
  signing_date: "Ngày ký",

  // Tóm tắt bệnh án
  ten_benh_vien: "Tên bệnh viện",
  ten_benh_nhan: "Tên bệnh nhân",
  so_ho_so_benh_an: "Số hồ sơ bệnh án",
  ngay_vao_vien_ra_vien: "Ngày vào / ra viện",
  chan_doan_vao_vien: "Chẩn đoán vào viện",
  chan_doan_ra_vien: "Chẩn đoán ra viện",
  ly_do_vao_vien: "Lý do vào viện",
  tom_tat_qua_trinh_benh_ly: "Tóm tắt quá trình bệnh lý",
  tien_su: "Tiền sử",
  tom_tat_ket_qua_xet_nghiem: "Tóm tắt kết quả xét nghiệm",

  // Hoá đơn
  danh_sach_hoa_don: "Danh sách hoá đơn",
  ten_don_vi_ban: "Tên đơn vị bán hàng",
  ma_so_thue: "Mã số thuế",
  dia_chi_don_vi_ban: "Địa chỉ đơn vị bán hàng",
  so_dien_thoai_don_vi_ban: "Số điện thoại đơn vị bán hàng",
  ky_hieu_serial: "Ký hiệu / Serial",
  so_hoa_don: "Số hoá đơn",
  ngay_hoa_don: "Ngày hoá đơn",
  ho_ten_nguoi_mua: "Họ tên người mua",
  cccd_nguoi_mua: "CCCD người mua",
  dia_chi_nguoi_mua: "Địa chỉ người mua",
  noi_dung_hoa_don: "Nội dung hoá đơn",
  don_vi_tinh: "Đơn vị tính",
  tong_tien_bang_so: "Tổng tiền bằng số",
  so_tien_bang_chu: "Số tiền bằng chữ",
  xac_nhan_nguoi_ban: "Xác nhận người bán",
  duong_link_tra_cuu: "Đường link tra cứu",
  ma_tra_cuu: "Mã tra cứu",
  tong_tien_thanh_toan: "Tổng tiền thanh toán",
  hinh_thuc_thanh_toan: "Hình thức thanh toán",

  // Bảng kê chi phí
  hanh_chinh: "Thông tin hành chính",
  so_benh_an: "Số bệnh án",
  so_ho_so: "Số hồ sơ",
  so_kham_benh: "Số khám bệnh",
  tong_chi_phi: "Tổng chi phí",
  tong_cong: "Tổng cộng",
  bhyt_chi_tra: "BHYT chi trả",
  bhyt_thanh_toan: "BHYT thanh toán",
  nguoi_benh_cung_chi_tra: "Người bệnh cùng chi trả",
  nguoi_benh_tu_tra: "Người bệnh tự trả",
  ...
  // Đơn thuốc
  so_toa_thuoc: "Số toa thuốc",
  ma_so_bhyt: "Mã số BHYT",
  dia_chi: "Địa chỉ",
  danh_muc_thuoc: "Danh mục thuốc",
  hoat_chat: "Hoạt chất",
  ten_thuoc: "Tên thuốc",
  lieu_dung: "Liều dùng",
  ngay_ke_don: "Ngày kê đơn",
  chu_ky_bac_si: "Có chữ ký bác sĩ",

  // Giấy yêu cầu bồi thường
  thong_tin_nguoi_duoc_bao_hiem: "Thông tin người được bảo hiểm",
  thong_tin_thanh_toan: "Thông tin thanh toán",
  chu_ky_ndbh: "Chữ ký người được bảo hiểm",
  ho_ten: "Họ và tên",
  ho_ten_ky: "Họ tên người ký",
  so_cccd_ho_chieu: "Số CCCD / Hộ chiếu",
  so_gcnbh_so_the_bh: "Số GCNBH / Số thẻ BH",
  nguoi_thu_huong: "Người thụ hưởng",
  so_tai_khoan: "Số tài khoản",
  ngan_hang: "Ngân hàng",
  so_tien_yeu_cau_chi_tra: "Số tiền yêu cầu chi trả",
